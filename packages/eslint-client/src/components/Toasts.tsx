        ...
        <div className='fixed inset-x-0 bottom-0 mx-auto flex max-w-screen-xl flex-col items-center justify-center gap-y-2 p-4'>
            {
                toasts.map(toast => (
                    ...
                    >
                        ...
                        <button
                            type="button"
                            className="-m-1.5 ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-white p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-gray-300"
